...
Usage:
    ...
    python3 scripts/batch_fit_sparc.py [data_file]
...
SRC_DIR = ROOT / 'src'
LEGACY_SRC = ROOT / 'legacy' / 'Pushing-Medium' / 'src'
...
def batch_fit_all(data_file=str(ROOT / 'tests' / 'data' / 'sparc_sample.csv'), n_random=300, n_refine=100):
    ...
    output_file = results_path / 'pm_sparc_fits.json'
...
if __name__ == '__main__':
    data_file = sys.argv[1] if len(sys.argv) > 1 else str(ROOT / 'tests' / 'data' / 'sparc_sample.csv')
