"""Data loading utilities for galaxy dynamics (mock and sample SPARC files)."""
...
def load_sparc_mock(path: str | Path, galaxy_name: Optional[str] = None) -> RotationCurve:
    ...
    with path.open('r', newline='') as f:
        ...
        alias_map = {'v_obs_kms': ['v_obs_kms', 'v_obs'], 'ev_kms': ['ev_kms', 'err_v']}
...
__all__ = [
    'RotationCurve', 'load_sparc_mock', 'load_sparc_real',
]
